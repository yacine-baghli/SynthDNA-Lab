...
if(d.status==='complete'){renderGenResults(d.result);document.getElementById('btn-generate').disabled=false;document.getElementById('btn-generate').innerHTML='<span class="btn-icon">&#9889;</span> Generate';return}
